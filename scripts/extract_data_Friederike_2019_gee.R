...
#### Load geometry data
# Geometries
damage_polygons <- vect("D:\\wsf-sat\\data\\validation\\Friedericke_2018\\Friedericke_2018_kartigebiet_zeitangepasst_nachkartiert260421.gpkg", layer = "filter025")
...
extract_values_no_damage$year <- 2018 
