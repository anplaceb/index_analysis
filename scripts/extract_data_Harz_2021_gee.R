...
#### Load raster data
rpast <- rast(im2list_11bands(r"{Y:\Andrea\wsf-sat\data\s2_mosaic_gee\s2_2020\gee_2020_11bands_harz.tif}"))
rpresent <- rast(im2list_11bands(r"{Y:\Andrea\wsf-sat\data\s2_mosaic_gee\s2_2021\gee_2021_11bands_harz.tif}"))
