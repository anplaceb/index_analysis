---
title: "mean_sd_analyse_detection_gee"
format: html
---
...
```{r}
d1 <- fread(here("output", "reference_Friedericke_2019_clean_gee.csv"), dec = ",")
d2 <- fread(here("output", "reference_Harz_2021_clean_gee.csv"), dec = ",")
...
ggplot(dataplot_diff,aes(x=diff, y=sd, col=Index,label=Index))+geom_point()+
